"""
Django settings for clinic_attendance project.
...
SECRET_KEY = 'django-insecure-h@h9al9txwi-h5u7wt!_44zdm%fe-n2%%nok-2hxkuw(o$b##$'
...
ROOT_URLCONF = 'clinic_attendance.urls'
...
WSGI_APPLICATION = 'clinic_attendance.wsgi.application'
